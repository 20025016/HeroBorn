...
public class LearningCurve : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Range exceptions can be avoided by getting the length of the array
        Debug.LogFormat("Team1 size: {0}", Team1.Length);
        Debug.LogFormat("Team2 size: {0}", Team2.Length);
        Debug.LogFormat("Team3 size: {0}", Team3.Length);
    }
}